...
int main(){
    ...
    cout << "Long Integer: " << long_integer << endl << endl;
    ...
    cout << "Short Integer: " << short_integer << endl << endl;
    ...
    cout << "Unsigned Integer: " << u_integer << endl << endl;
